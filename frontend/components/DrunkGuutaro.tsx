interface DrunkGuutaroProps {
  title?: string;
  subtitle?: string;
  hint?: string;
}

export default function DrunkGuutaro({
  title = "Oops! Guu-taro drank too much sake and is taking a nap!",
  subtitle = "Please call a human staff member!",
  hint = "(Guu-taro is recovering... try again in a moment)",
}: DrunkGuutaroProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full px-8 text-center gap-6">
      <div className="w-36 h-36 rounded-full overflow-hidden border-2 border-[#D4C4AE] bg-[#FFF9F0] animate-bounce"
        ...
        <img
          src="/guu-taro-drunk.jpg"
          alt="Guu-taro is hungover"
